...
/*   Updated: 2023/05/07 17:51:02 by lkavalia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 				a texure.
 */
static void	check_for_elements(t_hive *h, char *buffer, t_main *main)
{
...
{
	if (h->move < 5)
		parsing_cleaning(h, NULL, SPEED_TO_LITTLE);
	find_elements(h, main);
